...
-- Which years are represented in the
-- summer_games, winter_games, and
-- country_stats tables?
...
-- How many distinct countries are
-- represented in the countries and
-- country_stats table?
SELECT DISTINCT TRIM(country) as name
FROM countries
ORDER BY name ASC;
-- 203 both
...
-- How many distinct events are in the
-- winter_games and summer_games table?
...
-- Count the number of athletes who
-- participated in the summer games for
-- each country. Your output should have
-- country name and number of athletes in
-- their own columns. Did any country have
-- no athletes?
...
-- Write a query to list countries by total bronze medals, with
-- the highest totals at the top and nulls at the bottom.
